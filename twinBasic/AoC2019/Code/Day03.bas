...
'Const WIRE_1                       As LongLong = 0&
'Const WIRE_2                       As LongLong = 1&
'
'Public Function GetWireCrossings(ByVal ipWirePath1 As Kvp, ByVal ipWirePath2 As Kvp) As Kvp
'
'
'
'    Dim myStep As Variant
'    For Each myStep In ipWirePath1
'
'
'
'    Next
...
'
'
'Public Function GetWirePath(ByVal ipWireLinksDescription As Kvp) As Kvp
'
'    Dim myLink As Variant
'    For Each myLink In ipWireLinksDescription
'
'        Dim myDirection As String
'        myDirection = VBA.Left$(myCoord, 1)
'        Dim myLinkSteps As Long
'        myLinkSteps = CLng(Mid$(myCoord, 2))
'
'        '@Ignore VariableNotUsed, UndeclaredVariable
'        Dim myStep As Long
'        Dim myTotalSteps As Long
'        Dim myPath As Kvp: Set myPath = New Kvp
...
'
'            If myPath.LacksKey(myPosition) Then
'
'                myPath.AddByKey mySteps, New Kvp
'                myPath.Item(mySteps).AddByIndex myPosition
'
'            End If
'
'        Next
...
'    Next
'
'    Set GetWireListOfCrossings = myXY
'
'End Function


'Public Sub GetManhattenOfManhattenDistance()
'
'    Dim WirePaths As Kvp
'    Set WirePaths = GetDay03Input
'
'    Dim myItem                                  As Variant
'    Dim myListOfWireCrossings                   As Kvp
'
...
'Private Function GetDay03Input() As Kvp
'
'    Dim myFso  As Scripting.FileSystemObject: Set myFso = New Scripting.FileSystemObject
'    Dim myfile As TextStream
'    Set myfile = myFso.OpenTextFile("C:\Projects\Code\AdventOfCode\Day03\Day03paths.txt", ForReading)
'
'    Dim myKvp As Kvp
'    Dim myPath As String
'
'    myPath = myfile.ReadLine
'    myKvp.AddByIndexFromArray Split(myPath, ",")
'    myPath = myfile.ReadLine
'    myKvp.AddByIndexFromArray Split(myPath, ",")
'    myfile.Close
'
'    Set GetDay03Input = myKvp
'
'End Function
