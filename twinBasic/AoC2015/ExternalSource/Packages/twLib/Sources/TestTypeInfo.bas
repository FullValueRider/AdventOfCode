...
#End If
    ...
    Test01a_IsAString
    Test01b_IsNotAString
    Test01c_IsString
    Test01d_IsNotString
    
    Test02a_IsANumber
    Test02b_IsNotANumber
    Test02c_IsNumber
    Test02d_IsNotNumber
...
#End If
   ...
   'On Error GoTo TestFail
    ...
    myResult(0) = TypeInfo.IsItemObject(myTest, myTest)
    myResult(1) = TypeInfo.IsItemObject(42, myTest)
    myResult(2) = TypeInfo.IsItemObject("Hello", myTest)
    myResult(3) = TypeInfo.IsItemObject(Hkvp.Deb, myTest)
...
'@TestMethod("TypeInfo")
Private Sub Test00b_IsNotObject()
...
#End If
   ...
   'On Error GoTo TestFail
    ...
    myExpected = Array(False, True, True, False)
    ...
    'Act:
    myResult(0) = TypeInfo.IsNotItemObject(myTest, myTest)
    myResult(1) = TypeInfo.IsNotItemObject(42, myTest)
    myResult(2) = TypeInfo.IsNotItemObject("Hello", myTest)
    myResult(3) = TypeInfo.IsNotItemObject(Hkvp.Deb, myTest)
...
#End If
   ...
   'On Error GoTo TestFail
    ...
    Dim myIndex As Long
    For myIndex = 0 To 10
    myResult(myIndex) = TypeInfo.IsAString(myTest(myIndex))
    Next
    'Assert.Strict:
    AssertStrictSequenceEquals myExpected, myResult, myProcedureName
...
'@TestMethod("TypeInfo")
Private Sub Test01b_IsNotAString()
...
#End If
   ...
   'On Error GoTo TestFail
    ...
    Dim myIndex As Long
    For myIndex = 0 To 10
    myResult(myIndex) = TypeInfo.IsNotAString(myTest(myIndex))
    Next
    'Assert.Strict:
    AssertStrictSequenceEquals myExpected, myResult, myProcedureName
...
#End If
   ...
   'On Error GoTo TestFail
    ...
    Dim myIndex As Long
    For myIndex = 0 To 10
    myResult(myIndex) = TypeInfo.IsANumber(myTest(myIndex))
    Next
    'Assert.Strict:
    AssertStrictSequenceEquals myExpected, myResult, myProcedureName
...
'@TestMethod("TypeInfo")
Private Sub Test02b_IsNotANumber()
...
#End If
   ...
   'On Error GoTo TestFail
    ...
    Dim myIndex As Long
    For myIndex = 0 To 10
    myResult(myIndex) = TypeInfo.IsNotANumber(myTest(myIndex))
    Next
    'Assert.Strict:
    AssertStrictSequenceEquals myExpected, myResult, myProcedureName
...
#End If
    ...
    ' Vartype(LongPtr) returns vbLongLong or vbLong depending on the bitness of VBA
'#If Win64 Then
    myResult(8) = TypeInfo.IsNotANumber(myTest(8), NumberType.AsLongLong)
'# Else
  '  myResult(8) = TypeInfo.IsNumber(myTest(8), NumberType.AsLong)
'#End If

    
    myResult(9) = TypeInfo.IsNotANumber(myTest(9), NumberType.AsSingle)
