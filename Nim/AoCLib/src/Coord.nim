...
#             direction               : Direction.North.ord,                         
#             compassPoints           : ipCompassPoints,                          
            
#             firstRepeatVisit        : chars.twNoString,                   
#             mostRecentRepeatVisit   : chars.twNoString,                
                                
            
#             repeatVisit             : false,
#             heading                 : chars.twNoString,                              
#             mapType                 : ipMapType, 
#         )
#     )
    
#     result.p.CompassPoints = if ipCompassPoints == 4: 90 else: 45
...
#     if me.p.direction < 0:
#         me.p.direction = if me.p.compassPoints == Four: West.ord else: NW.ord
